...
Feature: F04_OrderProduct
  ...
  Scenario Outline: F04_2_UserCanOrder<Product Type #1>And<Product Type #2>
    ...
    And I click on '<Product Type #2>' top menu item
    ...
    And I click Place Order button on Payment page
    Then I verify that 'Order confirmed' page is 'opened'
    And I verify that '2' products are stored in ordered products table on Order confirmed page
